...
class UserPlan(models.Model):
    ...
    user_FK = models.ForeignKey(CustomUser, related_name='UserPlan_plan_FK', on_delete=models.CASCADE)
...
class FavoriteMovie(models.Model):
    movie_FK = models.ForeignKey(Plan, related_name='FavoriteMovie_movie_FK', on_delete=models.CASCADE)
